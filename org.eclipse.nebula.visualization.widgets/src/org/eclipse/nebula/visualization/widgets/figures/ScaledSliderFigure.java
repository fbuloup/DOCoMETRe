			...
			protected void fillShape(Graphics graphics) {		
				...
				if(effect3D && support3D) {		
					...
					if(horizontal){
						...
						graphics.drawRectangle(new Rectangle(bounds.x + getLineWidth() / 2,
							bounds.y + getLineWidth() / 2, 
							fillWidth - Math.max(1, getLineWidth()),
							bounds.height - Math.max(1, getLineWidth())));
						...
						graphics.drawRectangle(new Rectangle(bounds.x + getLineWidth() / 2,
							valuePosition+ getLineWidth() / 2, 
							bounds.width- Math.max(1, getLineWidth()),
							fillHeight - Math.max(1, getLineWidth())));
					}		
