...
public class Maximum extends GenericFunction {
	
	private static final long serialVersionUID = 1L;
	
	public static final String functionFileName = "MAXIMUM.FUN";
	...
	public Object getGUI(Object functionalBlockConfigurationDialog, Object parent, Object context) {
		...
		trialsListText.addModifyListener(new ModifyListener() {
			...
			public void modifyText(ModifyEvent e) {
				Maximum.this.functionalBlockConfigurationDialog.setErrorMessage(null);
				...
				if(putValue) getTransientProperties().put(trialsListKey, trialsListText.getText());
					...
					Maximum.this.functionalBlockConfigurationDialog.setErrorMessage(message);
				}
			}
		});
