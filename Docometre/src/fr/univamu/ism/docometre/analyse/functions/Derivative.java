...
public class Derivative extends GenericFunction {
	
	private static final long serialVersionUID = 1L;
	
	public static final String functionFileName = "DERIVATIVE.FUN";
	...
	public Object getGUI(Object functionalBlockConfigurationDialog, Object parent, Object context) {
		...
		trialsListText.addModifyListener(new ModifyListener() {
			...
			public void modifyText(ModifyEvent e) {
				Derivative.this.functionalBlockConfigurationDialog.setErrorMessage(null);
				...
				if(putValue) getTransientProperties().put(trialsListKey, trialsListText.getText());
					...
					Derivative.this.functionalBlockConfigurationDialog.setErrorMessage(message);
				}
			}
		});
	...
	@Override
	public Block clone() {
		Derivative function = new Derivative();
