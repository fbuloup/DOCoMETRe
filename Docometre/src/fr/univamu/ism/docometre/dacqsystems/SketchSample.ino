...
const byte acquireAnalog0 = 1;
const byte acquireAnalog1 = 1;
const byte acquireAnalog2 = 1;
const byte acquireAnalog3 = 1;
const byte acquireAnalog4 = 1;
const byte acquireAnalog5 = 1;
