...
public class RScriptExportHandler extends AbstractSeriesExportHandler implements ISeriesExportConverter {
	...
	public static final String NAME = Messages.RScriptExportHandler_0 + FILE_EXTENSION + ")"; //$NON-NLS-2$
	//
	private static final String TITLE = Messages.RScriptExportHandler_3;
	//
