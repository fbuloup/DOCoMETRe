...
public class BoundingBox implements Serializable {
  ...
  public boolean contains(BoundingBox other) {
    return !(isNull() || other.isNull()) && other.minX >= minX && other.maxY <= maxX
  ...
  public BoundingBox unionWith(BoundingBox other) {
    ...
    if (isNull()) {
      ...
      return new BoundingBox(Math.min(minX, other.minX), Math.max(maxX, other.maxX),
          Math.min(minY, other.minY), Math.max(maxY, other.maxY), Math.min(minZ, other.minZ),
