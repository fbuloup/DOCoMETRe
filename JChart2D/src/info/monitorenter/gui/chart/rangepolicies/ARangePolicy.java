...
public abstract class ARangePolicy implements IRangePolicy {
  ...
  public void setRange(final Range range) {
    ...
    if (minchanged && maxchanged) {
      ...
      this.firePropertyChange(IRangePolicy.PROPERTY_RANGE_MIN, Double.valueOf(oldMin), Double.valueOf(range .getMin()));
    } else if (maxchanged) {
      this.firePropertyChange(IRangePolicy.PROPERTY_RANGE_MAX, Double.valueOf(oldMax), Double.valueOf(range.getMax()));
    }
